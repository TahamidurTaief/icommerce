    ...
    <div>
      <button
        ...
        className={`group w-full ${
          isSelected
            ...
            : "border border-blue-500 text-white hover:border-blue-500 hover:bg-blue-500"
      ...
      >
        <div className="flex flex-row gap-2 items-center px-1 py-1">
          ...
          <div>
            <h3
              className={`font-medium text-sm lato ${
                isSelected
                  ? "text-white"
                  : "dark:text-white text-blue-500 hover:text-white"
              }`}
            >
              {title}
            </h3>
